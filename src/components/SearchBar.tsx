...
const SearchBar = () => {
  return (
    <div
      className="absolute top-4 left-1/2 z-10 transform -translate-x-1/2 bg-grey-950 text-primary-200 p-2 rounded-full shadow-md w-[94%] max-w-md flex items-center border border-1 border-primary-200"
    >
